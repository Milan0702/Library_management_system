...
class menu:
    def __init__(self):
        ...
        l1=Button(self.a,text='BOOK DATA',font='"Comic Sans M" 22 bold',fg='black',bg='white',width=19,padx=10,borderwidth=0,command=self.book).place(x=100,y=250)
        l2=Button(self.a,text='STUDENT DATA',font='"Comic Sans M" 22 bold',fg='black',bg='white',width=19,padx=10,borderwidth=0,command=self.student).place(x=100,y=500)
        l3=Label(self.a,text='CROSSWORD LIBRARY',font='Papyrus 23 bold',fg='black',bg='white',pady=1).place(x=800,y=380)
        self.root.mainloop()
    ...
    def book(self):
        ...
        l1=Button(self.a,text='Add Books',font='"Comic Sans M" 22 bold',fg='black',bg='white',width=15,padx=10,command=self.addbook).place(x=40,y=150)
        l2=Button(self.a,text='Search Books',font='"Comic Sans M" 22 bold',fg='black',bg='white',width=15,padx=10,command=self.search).place(x=40,y=250)

        l4=Button(self.a,text='All Books',font='"Comic Sans M" 22 bold',fg='black',bg='white',width=15,padx=10,command=self.all).place(x=40,y=350)
        l4=Button(self.a,text='<< Main Menu',font='"Comic Sans M" 22 bold',fg='black',bg='white',width=15,padx=10,command=self.mainmenu).place(x=40,y=500)
    ...
    def addbook(self):
        ...
        l1=Label(self.f1,text='Book ID : ',font='"Comic Sans M" 12 bold',fg='black',bg='white',pady=1).place(x=50,y=50)
        e1=Entry(self.f1,width=45,bg='white',fg='black',textvariable=self.aid).place(x=150,y=50)
        l2=Label(self.f1,text='Title : ',font='"Comic Sans M" 12 bold',fg='black',bg='white',pady=1).place(x=50,y=100)
        e2=Entry(self.f1,width=45,bg='white',fg='black',textvariable=self.aname).place(x=150,y=100)
        l3=Label(self.f1,text='Author : ',font='"Comic Sans M" 12 bold',fg='black',bg='white',pady=1).place(x=50,y=150)
        e3=Entry(self.f1,width=45,bg='white',fg='black',textvariable=self.aauthor).place(x=150,y=150)
        l4=Label(self.f1,text='Genre : ',font='"Comic Sans M" 12 bold',fg='black',bg='white',pady=1).place(x=50,y=200)
        e2=Entry(self.f1,width=45,bg='white',fg='black',textvariable=self.agenre).place(x=150,y=200)
        l4=Label(self.f1,text='Copies : ',font='"Comic Sans M" 12 bold',fg='black',bg='white',pady=1).place(x=50,y=250)
        e2=Entry(self.f1,width=45,bg='white',fg='black',textvariable=self.acopies).place(x=150,y=250)
        l5=Label(self.f1,text='Location : ',font='"Comic Sans M" 12 bold',fg='black',bg='white',pady=1).place(x=50,y=300)
        e3=Entry(self.f1,width=45,bg='white',fg='black',textvariable=self.aloc).place(x=150,y=300)
        self.f1.grid_propagate(0)
        b1=Button(self.f1,text='Add',font='"Comic Sans M" 10 bold',fg='black',bg='Orange',width=15,bd=3,command=self.adddata).place(x=200,y=400)
        b2=Button(self.f1,text='Back',font='"Comic Sans M"Sans M" 10 bold',fg='black',bg='white',width=15,bd=3,command=self.rm).place(x=350,y=400)
    ...
    def adddata(self):
        ...
        except sqlite3.IntegrityErrors:
    ...
    def search(self):
        ...
        self.f1=Frame(self.a,height=500,width=650,bg='black')
        self.f1.place(x=500,y=100)
        l1=Label(self.f1,text='Book ID/Title/Author/Genre: ',font=('"Comic Sans M" 10 bold'),bd=2, fg='black',bg='white').place(x=20,y=40)
        e1=Entry(self.f1,width=25,bd=5,bg='white',fg='black',textvariable=self.sid).place(x=260,y=40)
        b1=Button(self.f1,text='Search',bg='orange',font='"Comic Sans M" 10 bold',width=9,bd=2,command=self.serch1).place(x=500,y=37)
        b1=Button(self.f1,text='Back',bg='orange',font='"Comic Sans M" 10 bold',width=10,bd=2,command=self.rm).place(x=250,y=450)
    ...
    def serch1(self):
        ...
        if k!="":
            ...
            if len(a)!=0:
                ...
                self.cm =ttk.Combobox(self.f1,textvariable=self.variable ,state='readonly',font='"Comic Sans M" 15 bold',height=50,width=15,)
    ...
    def deleteitem(self):
        try:
            ...
            b1=Button(self.f1,text='Update',font='"Comic Sans M" 10 bold',width=9,bd=3,command=self.delete2).place(x=500,y=97)
    ...
    def copies(self,varr):
        try:
            ...
            if varr==0:
                b5=Button(self.f1,text='Update',font='"Comic Sans M" 10 bold',bg='white',fg='black',width=9,bd=3,command=self.copiesadd).place(x=500,y=97)
            if varr==1:
                b6=Button(self.f1,text='Update',font='"Comic Sans M" 10 bold',bg='white',fg='black',width=9,bd=3,command=self.copiesdelete).place(x=500,y=97)
        except:
            messagebox.showinfo("Empty","Please select something.")
    ...
    def student(self):
        self.a.destroy()
        self.a=self.canvases(image2)
        l1=Button(self.a,text='Issue book',font='"Comic Sans M" 22 bold',fg='black',bg='white',width=15,padx=10,command=self.issue).place(x=40,y=150)
        l2=Button(self.a,text='Return Book',font='"Comic Sans M" 22 bold',fg='black',bg='white',width=15,padx=10,command=self.returnn).place(x=40,y=250)
        l3=Button(self.a,text='Student Activity',font='"Comic Sans M" 22 bold',fg='black',bg='white',width=15,padx=10,command=self.activity).place(x=40,y=350)
        l4=Button(self.a,text='<< Main Menu',font='"Comic Sans M" 22 bold',fg='black',bg='white',width=15,padx=10,command=self.mainmenu).place(x=40,y=550)
    ...
    def issue(self):
        ...
        self.f1.place(x=500,y=100)
        l1=Label(self.f1,text='Book ID : ',font='"Comic Sans M" 15 bold',bg='white',fg='black').place(x=50,y=100)
        e1=Entry(self.f1,width=25,bd=4,bg='white',textvariable=self.aidd).place(x=180,y=100)
        l2=Label(self.f1,text='Student Id : ',font='"Comic Sans M" 15 bold',bg='white',fg='black').place(x=50,y=150)
        e2=Entry(self.f1,width=25,bd=4,bg='white',textvariable=self.astudentt).place(x=180,y=150)
        b1=Button(self.f1,text='Back',font='"Comic Sans M" 10 bold',fg='black',bg='orange',width=10,bd=3,command=self.rm).place(x=50,y=250)
        b1=Button(self.f1,text='Issue',font='"Comic Sans M" 10 bold',fg='black',bg='orange',width=10,bd=3,command=self.issuedbook).place(x=200,y=250)
    ...
    def returnn(self):
        ...
        self.f1=Frame(self.a,height=550,width=500,bg='black')
        self.f1.place(x=500,y=100)
        l1=Label(self.f1,text='Book ID : ',font='"Comic Sans M" 15 bold',fg='black', bg='white').place(x=50,y=100)
        e1=Entry(self.f1,width=25,bd=4,bg='white',textvariable=self.aidd).place(x=180,y=100)
        l2=Label(self.f1,text='Student Id : ',font='"Comic Sans M" 15 bold',fg='black', bg='white').place(x=50,y=150)
        e2=Entry(self.f1,width=25,bd=4,bg='white',textvariable=self.astudentt).place(x=180,y=150)
        b1=Button(self.f1,text='Back',font='"Comic Sans M" 10 bold',bg='orange',fg='black',width=10,bd=3,command=self.rm).place(x=50,y=250)
        b1=Button(self.f1,text='Return',font='"Comic Sans M" 10 bold',bg='orange',fg='black',width=10,bd=3,command=self.returnbook).place(x=200,y=250)
        self.f1.grid_propagate(0)
    ...
    def activity(self):
        ...
        l1=Label(self.f1,text='Book/Student ID : ',font='"Comic Sans M" 15 bold',fg='orange',bg='black').place(x=50,y=30)
        e1=Entry(self.f1,width=20,bd=4,bg='orange',textvariable=self.aidd).place(x=280,y=35)
        b1=Button(self.f1,text='Back',bg='white',font='"Comic Sans M" 10 bold',width=10,bd=3,command=self.rm).place(x=340,y=450)
        b1=Button(self.f1,text='Search',bg='white',font='"Comic Sans M" 10 bold',width=10,bd=3,command=self.searchact).place(x=40,y=450)
        b1=Button(self.f1,text='All',bg='white',font='"Comic Sans M" 10 bold',width=10,bd=3,command=self.searchall).place(x=190,y=450)
        self.f1.grid_propagate(0)
...
USERNAME = StringVar()
PASSWORD = StringVar()
lbl_title = Label(canvas, text = "ADMIN  LOGIN", font=('Comic Sans MS', 35,'bold', ),bg='white', fg='black')
lbl_title.place(x=550,y=200)
lbl_username = Label(canvas, text = "Username:", font=('Comic Sans M', 15,'bold'),bd=4,bg='white', fg='black')
lbl_username.place(x=550,y=330)
lbl_password = Label(canvas, text = "Password :", font=('Comic Sans M', 15,'bold'),bd=3, bg='white', fg='black')
lbl_password.place(x=550, y=430)
lbl_text = Label(canvas)
lbl_text.place(x=500,y=600)
lbl_text.grid_propagate(0)

username = Entry(canvas, textvariable=USERNAME, font=(14), bg='white', fg='black',bd=6)
username.place(x=700, y=330)
password = Entry(canvas, textvariable=PASSWORD, show="*", font=(14),bg='white', fg='black',bd=6)
password.place(x=700, y=430)

btn_login = Button(canvas, text="LOGIN", font=('"Comic Sans M" 15 bold'),width=32,command=Login, bg='white', fg='black')
btn_login.place(x=550,y=500)
